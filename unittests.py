...
contname = 'kvs'  # Set your container name here
...
class TestHW2(unittest.TestCase):
    ...
    def spin_up_nodes(self):
        ...
        #print(subprocess.check_output(exec_string_main, shell=True))
    ...
    def test_a_put_nonexistent_key(self):
        ...
        d = res.json()
        print res.status_code, "res", res, "res.json()", res.json()
        print self.__class__.nodes_address[0]
